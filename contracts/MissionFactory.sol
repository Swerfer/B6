...
contract Mission is Ownable, ReentrancyGuard {
    constructor() Ownable(address(0)) {}        // Initialize with zero address to allow later initialization (Contructor is not used in clones, but compiler complains without constructor)
